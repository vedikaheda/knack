...
import { registerGetAttendeeBotTool } from "./tools/getAttendeeBot";
import { registerGetAttendeeTranscriptTool } from "./tools/getAttendeeTranscript";
import { registerStartAttendeeBotTool } from "./tools/startAttendeeBot";
...
export default function registerPlugin(api: any) {
  ...
  registerStartAttendeeBotTool(api);
  registerGetAttendeeBotTool(api);
  registerGetAttendeeTranscriptTool(api);
