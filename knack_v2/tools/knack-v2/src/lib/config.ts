type PluginConfig = {
  ...
  ATTENDEE_BASE_URL?: string;
  ATTENDEE_API_KEY?: string;
  ATTENDEE_DEFAULT_BOT_NAME?: string;
  ATTENDEE_TRACKED_BOTS_PATH?: string;
  ATTENDEE_SARVAM_LANGUAGE_CODE?: string;
  ATTENDEE_SARVAM_MODEL?: string;
